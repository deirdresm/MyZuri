...
extension MyZuriSchemaV2p1 {
	...
	@Observable final class ItemColor: Identifiable, Codable, Equatable, Comparable, Hashable {
//		var id: UUID
...
//			self.id = UUID()
		...
		static func == (lhs: MyZuriSchemaV2p1.ItemColor, rhs: MyZuriSchemaV2p1.ItemColor) -> Bool {
